...
type StockRepoI interface {
	...
	Transfer(ctx context.Context, req *models.TransferStock) error 
}
...
type StaffRepoI interface {
	...
	GetStaffSellsById(ctx context.Context, req *models.StaffPrimaryKey) (*models.GetStaffSellsById, error)
...
type PromoRepoI interface {
	...
	GetByID(ctx context.Context, req *models.PromoPrimaryKey) (*models.Promo_code, error)	
	GetList(ctx context.Context, req *models.GetListPromoRequest) (res *models.GetListPromoResponse, err error)
